...
import { 
  FaLaptopCode, FaReact, FaNodeJs, FaDatabase, FaCss3Alt, FaHtml5, 
  FaVuejs, FaAngular, FaSwift, FaRust, FaDocker, FaGitAlt, FaLinux, FaWindows, FaApple, 
  FaSass, FaGoogle,   FaGitlab, FaBitbucket, FaCuttlefish,
