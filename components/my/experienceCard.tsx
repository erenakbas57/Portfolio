...
const ExperienceCard: React.FC<ExperienceCardProps> = ({ experience }) =>{
  return (
    <div className="ml-16">
      <Card className={`border-l-4 border-r-2 border-y-2 ${experience.color}`}>
        <CardHeader>
          <CardTitle className="flex text-2xl items-center gap-3 text-orange-600 dark:text-orange-400">
